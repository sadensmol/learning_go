...
const file_proto_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x13proto/v1/user.proto\x12\x04user\")\n" +
	...
	"\n" +
	"CreateUser\x12\x17.user.CreateUserRequest\x1a\x18.user.CreateUserResponseB&Z$grpc-backward-compat/proto/v1;userv1b\x06proto3"
